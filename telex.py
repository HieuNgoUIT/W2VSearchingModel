class Telex():
    def __init__(self):
        self.ascii_number = [7845, 7847, 7849, 7851, 7853, 226, 225, 224, 7843, 227, 7841, 7855, 7857, 7859, \
        ...
        self.telex_plain = ["aas", "aaf", "aar", "aax", "aaj", "aa", "as", "af", "ar", "ax", "aj", "aws", "awf", \
    ...
    def uni2telex(self,my_string):
            for i,v in enumerate(self.telex_plain):
                if v in my_string:
                    my_string = my_string.replace(v,chr(self.ascii_number[i])) 
            return my_string
    
    def telex2uni(self,my_string):
            for i,v in enumerate(self.ascii_number):
                if chr(v) in my_string:
                    my_string = my_string.replace(v,self.telex_plain[i]) 
            return my_string